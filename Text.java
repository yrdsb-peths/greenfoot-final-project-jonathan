...
{  
    public Text(int id)
    {
        ...
        if(id == 58)
        {
            setImage("images/CharacterText/Text58.png");
        }
        
        if(id == 59)
        {
            setImage("images/CharacterText/Text59.png");
        }
        
        if(id == 60)
        {
            setImage("images/CharacterText/Text60.png");
        }
        ...
        if(id == 80)
        {
            setImage("images/CharacterText/Text80.png");
        }
        
        if(id == 81)
        {
            setImage("images/CharacterText/Text81.png");
        }
    }
